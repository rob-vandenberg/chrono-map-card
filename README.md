...
Take a look at the blog post [introducing the custom:map-card for Home Assistant](https://nathan.gs/2024/01/06/chrono-map-card-a-new-and-alternative-leaflet-based-map/).

![An example of the custom:map-card](chrono-map-card-pm25.png)

### Installation

#### HACS

[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=nathan-gs&repository=chrono-map-card&category=plugin)
...
>
> Take a look at:
> https://nathan.gs/2024/01/06/chrono-map-card-a-new-and-alternative-leaflet-based-map/#a-more-advanced-example-measuring-pm25-air-quality-for-my-home
...
| name      | description                                                                                         |
|-----------|-----------------------------------------------------------------------------------------------------|
| [`bom-radar`](https://github.com/bezmi/chrono-map-card-plugin-bom-radar) | Displays the Australian BoM rainfall radar for the past 90 minutes and the radar forecast for the next 90 minutes as an overlay on the map. |
| [`buienradar`](https://github.com/Kevinjil/chrono-map-card-buienradar) | Displays `buienradar.nl` as an overlay on the map |

You can find more plugins using the [chrono-map-card-plugin](https://github.com/topics/chrono-map-card-plugin) topic.
...
`git clone git@github.com:nathan-gs/chrono-map-card.git`
...
* Typescript example: see [bezmi/chrono-map-card-plugin-bom-radar](https://github.com/bezmi/chrono-map-card-plugin-bom-radar).
* For an example HACS plugin installation: see [`buienradar`](https://github.com/Kevinjil/chrono-map-card-buienradar).

Tag your Github repo with [chrono-map-card-plugin](https://github.com/topics/chrono-map-card-plugin) for discoverability.
...
* [nathan.gs: Map Card, a new leaflet based map with WMS and other advanced features](https://nathan.gs/2024/01/06/chrono-map-card-a-new-and-alternative-leaflet-based-map/)
* [nathan.gs: Map Card, displaying Weather and Other Tile Layers](https://nathan.gs/2024/02/25/chrono-map-card-displaying-weather-and-other-tilelayers/)
...
We have a gallery of nice examples at [nathan.gs/chrono-map-card](https://nathan.gs/chrono-map-card/), contributions are welcome, check the [showcase/README.md](showcase/README.md).